...
diccionarioListing={
        ...
        "beds": types.Integer(),
        "price": types.Text(),
        "price_float": types.Float(),
        "minimum_nights_avg_ntm": types.Float(),
        "maximum_nights_avg_ntm": types.Float(),
        ...
        "review_scores_rating": types.Float(),
        "review_scores_accuracy": types.Float(),
        "review_scores_cleanliness": types.Float(),
        "review_scores_checkin": types.Float(),
        "review_scores_communication": types.Float(),
        "review_scores_location": types.Float(),
        "review_scores_value": types.Float(),
        "reviews_per_month": types.Float(),
